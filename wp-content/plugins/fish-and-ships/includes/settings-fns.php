...
foreach ( $currencies as $currency => $symbol ) {
	...
	$settings['min_shipping_price' . $lang_sufix] = array(
		...
		'type'              => 'text',
		'class'				=> 'wc_fns_input_decimal min_shipping_price_field ' . ($n == 1 ? 'currency-main' : 'currency-secondary'),
		'placeholder'       => '[none]',
...
foreach ( $currencies as $currency => $symbol ) {
	...
	$settings['max_shipping_price' . $lang_sufix] = array(
		...
		'type'              => 'text',
		'class'				=> 'wc_fns_input_decimal max_shipping_price_field ' . ($n == 1 ? 'currency-main' : 'currency-secondary'),
		'placeholder'       => '[none]',

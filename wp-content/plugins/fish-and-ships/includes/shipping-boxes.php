...
if ( !class_exists( 'Fish_n_Ships_SB' ) ) {
	...
	class Fish_n_Ships_SB {
		...
		function print_form_line ($box) {
			...
			echo '<td class="fns-sb-num"><input type="text" name="fns-sb-length[]" value="' . esc_attr($box['length']) . '" class="wc_fns_input_decimal" required /></td>';
			echo '<td class="fns-sb-num"><input type="text" name="fns-sb-width[]" value="' . esc_attr($box['width']) . '" class="wc_fns_input_decimal" required /></td>';
			echo '<td class="fns-sb-num"><input type="text" name="fns-sb-height[]" value="' . esc_attr($box['height']) . '" class="wc_fns_input_decimal" required /></td>';
			echo '<td class="fns-sb-num"><input type="text" name="fns-sb-weight[]" value="' . esc_attr($box['weight']) . '" class="wc_fns_input_decimal" required /></td>';
